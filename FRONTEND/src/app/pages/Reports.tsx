...
const defaultRawData = [
  ...
  { id: 3, date: "2024-04-13", session: "Project Architecture", duration: "3h 00m", efficiency: 85, status: "Great" },
  { id: 4, date: "2024-04-13", session: "Email & Admin", duration: "0h 45m", efficiency: 60, status: "Distracted" },
  { id: 5, date: "2024-04-12", session: "Algorithm Research", duration: "2h 45m", efficiency: 88, status: "Great" },
];
