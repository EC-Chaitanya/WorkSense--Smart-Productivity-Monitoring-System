...
import { Clock, TrendingUp, Zap, ZapOff, Play, Target, Sparkles, ChevronRight, Briefcase, GraduationCap } from "lucide-react";
  ...
  return (
    <div className={cn("space-y-6 pb-12 relative", isStudent ? "font-sans" : "font-sans tracking-tight")}>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-12 w-full">
            <AnimatedRing score={84} isStudent={isStudent} />
        ...
        >
          ...
          <div className="relative z-10">
             ...
             <p className={cn("font-extrabold mb-1 tracking-tight transform origin-left transition-transform duration-300", isStudent ? "text-slate-900 dark:text-white text-4xl group-hover:scale-105" : "text-white text-3xl")}>4h 30m</p>
          ...
          <div className="relative z-10 mt-8">
             <div className={cn("flex justify-between mb-2 text-slate-700 dark:text-[#A1A1AA]", isStudent ? "text-sm font-bold" : "text-xs font-medium")}>
               <span>Progress</span>
               <span className={cn(isStudent ? "text-[#7C3AED]" : "text-white font-bold")}>68%</span>
             </div>
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard title={isStudent ? "Study Time" : "Deep Work Hours"} value="5h 12m" icon={Clock} trend="+12%" positive delay={0.1} mode={mode} />
        <StatCard title="Distracting Time" value="1h 05m" icon={ZapOff} trend="-5%" positive delay={0.2} mode={mode} />
        <StatCard title="Break Time" value="45m" icon={Zap} trend="+2%" positive={false} delay={0.3} mode={mode} />
      ...
      >
        {/* Line Chart */}
        <TiltCard tiltAmount={isStudent ? 2 : 0} glow={false} className={cn(
                ...
                <AreaChart data={lineData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  ...
                  <Area 
                    ...
                    activeDot={{ 
                      ...
                      shadow: isStudent ? '0 0 10px rgba(91,140,255,0.5)' : '0 0 10px rgba(34,211,238,0.5)' 
                    }} 
                  />
                </AreaChart>
              </ResponsiveContainer>
